        ...
        <>
            <nav className="bg-at-purple p-4">
                <div className="mx-auto flex max-w-screen-2xl items-center justify-between ">
                    <div className="block pb-3 pl-3 font-bold text-white">
                        <img className="w-13" src={logo}></img>
                    </div>
                    ...
                    >
                        ...
                        <ul className="items-center justify-center gap-[3vw] md:flex">
            ...
            <div className="mx-auto max-w-screen-2xl">
                <section className="lg:max-h-128 overflow-hidden">
                    <div className="flex h-full w-full items-center justify-center lg:z-30">
                        <img src={heroImage} alt="Hero Image" />
                    </div>
                    <div className="heroText bg-gradient-to-r from-at-green to-at-blue px-5 pb-8 pt-6 max-md:w-full lg:z-40 lg:max-w-xl lg:-translate-y-64 lg:translate-x-12">
                ...
                <section className="mb-12 ml-5 mr-5 mt-20 justify-center md:m-8">
                    ...
                    <div className="bg-at-purple-light mx-auto mb-4 w-full max-w-4xl rounded-lg p-4">
                        <button
                        ...
                        {!isCollapsed1 && (
                            <div className="mt-2">
                                <p className="text-at-grey font-inter font-normal leading-7">
